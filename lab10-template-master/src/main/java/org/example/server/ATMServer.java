...
public class ATMServer {
    ...
    public ATMServer() {
        ...
        try {
            ...
            System.out
                    .println("Waiting for clients to connect: up-to " + MAX_CLIENTS + " clients in total are allowed.");
            ...
            System.err.println(
                    "IOException while creating server connection. Total connections used to date:" + numClients);
        }
    }
